// Минималистичные иконки для нижней навигации (наследуют currentColor)
...
export function IconAdd({ className = base }: IconProps) {
  return (
...
export function IconCredit({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
